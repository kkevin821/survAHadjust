...
For example, `res$ahsw` contains bootstrap-based inference for group-specific AHSW, the AHSW difference, and the log ratio. The rows of `res$ahsw` are:
...
To preview the vignette without installing the package, open the file in RStudio and click **Knit**.

...
For example, `res$ahsw` gives bootstrap-based inference for AHSW. The `log_dif` row is the log ratio of average hazards. The ratio and its confidence interval can be obtained by exponentiating the log-scale values:
